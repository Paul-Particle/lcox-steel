...
Where `d1_area_average.py` collapses a country to one CF series via the
...
Cell extraction reuses the per-cell-grid pattern from d4_tilt_mix.py
...
_OUT = TIMESERIES / "DE_LU_wind-onshore_multi-n10_20230101_20231231.parquet"
_REGION = "DE"
...
def main() -> None:
    ...
    log.info(f"computing {_TECH} CF grid for {_AREA}")
