...
`test_window_completeness.py` pins the behaviour of `_helpers_grid.assert_window_complete`,
...
downstream as NaN after a reindex (e.g. a solve aligning prices to a full
